...
import { Text, Image, View, StyleSheet, TouchableOpacity, Dimensions, Platform, PixelRatio } from 'react-native';
...
export default class Strategies extends Component {
	...
	const strategies = [
		...
		"From nothing to more than nothing",
		"Be less critical more often",];
	let randomStrategy = _.sample(strategies);
	let seenStrategies = [];
	state = {
		seenStrategies: [],
		randomStrategy: _.sample(strategies),
	}
}
	...
	render() {
		return (
			<View style={styles.container}>
				<Text style={styles.strategies}>{randomStrategy}</Text>
			</View>
		);
	}
}
